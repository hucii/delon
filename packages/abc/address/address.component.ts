 ...
 * 城市选择器组件
 * Usage:
 * <ad-address [(ngModel)]="city.id" [options]="{...}"></ad-address>
 */
@Component({
  selector: 'ad-address',
  template: `<div class="ngx-address" [offClick]="onClose">
    ...
    <div class="ngx-address-overlay" *ngIf="_t.inited" [hidden]="!_t.opened"
    [ngStyle]="{'top.px': options.offset.y,'left.px': options.offset.x}">
...
export class AddressComponent
  ...
  @Output() public onSelected: EventEmitter<Result> = new EventEmitter();
